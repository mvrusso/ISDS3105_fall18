...
t#note how "time" becomes a factor-- more details at http://r4ds.had.co.nz/factors.html#creating-factors
```
...
iphoneSales[iphoneSales$iPhoneSE,]
...
mean(as.numeric(iphoneSales[iphoneSales$time == 'Jun 2018',-c(1)]), na.rm = TRUE)

  
as.numeric(iphoneSales[iphoneSales$time == 'Jun 2018',-c(1)])
